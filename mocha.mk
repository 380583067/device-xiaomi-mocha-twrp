...
# Audio
PRODUCT_COPY_FILES += \
    device/xiaomi/mocha/audio/audio.mocha.xml:system/vendor/etc/audio.mocha.xml \
    device/xiaomi/mocha/audio/audio_policy_configuration.xml:system/vendor/etc/audio_policy_configuration.xml \
    device/xiaomi/mocha/audio/nvaudio_conf.xml:system/etc/nvaudio_conf.xml \
    device/xiaomi/mocha/audio/nvaudio_fx.xml:system/etc/nvaudio_fx.xml  \
    device/xiaomi/mocha/audio/audio_effects.xml:system/vendor/etc/audio_effects.xml
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/av/services/audiopolicy/config/usb_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/usb_audio
...
PRODUCT_COPY_FILES += \
    ...
    device/xiaomi/mocha/camera/model_frontal.xml:system/vendor/etc/model_frontal.xml
...
PRODUCT_COPY_FILES += \
    ...
    device/xiaomi/mocha/media/media_profiles_V1_0.xml:system/etc/media_profiles_v1_0.xml \
...
PRODUCT_COPY_FILES += \
    ...
    device/xiaomi/mocha/permissions/com.nvidia.feature.opengl4.xml:system/etc/permissions/com.nvidia.feature.opengl4.xml 
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.camera.autofocus.xml:/etc/permissions/android.hardware.camera.autofocus.xml \
